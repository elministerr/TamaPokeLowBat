...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  // ---------------- ES ----------------
  {
    ...
    "SON OFF", "SON BAJO", "SON MEDIO", "SON ALTO",
  ...
  // ---------------- EN ----------------
  {
    ...
    "SND OFF", "SND LOW", "SND MEDIUM", "SND HIGH",
  ...
  // ---------------- FR ----------------
  {
    ...
    "SON OFF", "SON BAS", "SON MOYEN", "SON FORT",
  ...
  // Un byte por caracter: strlen() sigue midiendo bien y el centrado no cambia.
  {
    ...
    "TON AUS", "TON LEISE", "TON MITTEL", "TON LAUT",
  ...
  // ---------------- IT ----------------
  {
    ...
    "AUD OFF", "AUD BASSO", "AUD MEDIO", "AUD ALTO",
